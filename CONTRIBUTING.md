...
The maintainers of betwixt can be reached most easily via email:
...
However, to establish a baseline of acceptable conduct, the betwixt project expects contributors to adhere to
...
> [!Note]
> The maintainers of betwixt _hate_ the use of `!` to indicate breaking changes in the subject line. If you
...
> [!Note]
> The maintainers of betwixt don't like starting the docstring on the same line as the triple-quotes.
