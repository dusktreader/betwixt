"""Main entry point for the betwixt demo."""
...
def start(
    ...
    """
    This cli app will demo the features of `betwixt`!
    ...
    for selected_feature in features:
        feature_map[selected_feature] = get_demo_functions(selected_feature)
    ...
    greeting_lines = [
        ...
        "",
        "This program will show you the different features available in `betwixt` and what it's like to use them",
        "",
        "The following features will be included:",
    ]
    for selected_feature in features:
        label = override_label_map.get(selected_feature, f"{selected_feature}()")
    ...
    for selected_feature, demos in feature_map.items():
        for demo in demos:
            further = run_demo(demo, console, override_label=override_label_map.get(selected_feature))
            if not further:
                break
